...
<!-- 사용자 정의 자바스크립트 -->
	...
	// jQuery를 이용함
		 $(function() {
			...
			});	 //아래 코드가 다 실행된 후 실행 시킨다. (자바스크립트에서 이벤트처리) */
			...
			$("#btnAjax").click(function() {
				...
				$.ajax({
					url: "fileUploadAjax",
					method: "post",
					data: formData, // FormData객체를 만들어  data에 넣어줌
					cache: false,
					processData: false,
					contentType: false,
							...
							<div class="card-body">
								<form method="post" enctype="multipart/form-data" action="fileUpload">
								   ...
								   <div class="mt-2 form-group">
								     ...
								     <!-- 방법2 -->
								     <button id="btnAjax" class="my-2 btn btn-info btn-sm" type="button">AJAX 파일 업로드</button>
								</form>							
							</div>
						</div>
						<!-- ###################################### -->
